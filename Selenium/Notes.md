...
## [Browser Control Methods](Selenium/Selenium/Notes.md#Browser-Control-Methods)

| Method                          | Description                                      |
|--------------------------------|--------------------------------------------------|
| [`get(String url)`](Selenium/Selenium/Notes.md#get(String-url))              | Opens the given URL in the browser              |
